    ...
    data() {
        return {
            ...
            buyItems: [
                ...
                { id: 5, name: '柯基', image: require("@/assets/img/dog.png"), category: 'pet', description: '可靠的护卫，忠诚而勇敢，像你的影子一样一直陪伴着你', extra: { price: '￥20' } },
                { id: 6, name: '苹果', image: require("@/assets/img/apple.png"), category: 'food', description: '禁忌和知识的诱惑', extra: { price: '￥13' } },
                ...
                { id: 11, name: '柯基', image: require("@/assets/img/dog.png"), category: 'pet', description: '可靠的护卫，忠诚而勇敢，像你的影子一样一直陪伴着你', extra: { price: '￥20' } },
                { id: 12, name: '苹果', image: require("@/assets/img/apple.png"), category: 'food', description: '禁忌和知识的诱惑', extra: { price: '￥13' } },
                ...
                { id: 15, name: '柯基', image: require("@/assets/img/dog.png"), category: 'pet', description: '可靠的护卫，忠诚而勇敢，像你的影子一样一直陪伴着你', extra: { price: '￥20' } },
                { id: 16, name: '苹果', image: require("@/assets/img/apple.png"), category: 'food', description: '禁忌和知识的诱惑', extra: { price: '￥13' } },
            ],
            // 用户可以卖的物品
            soldItems: [
                ...
                { id: 6, name: '苹果', image: require("@/assets/img/apple.png"), category: 'food', description: '禁忌和知识的诱惑', extra: { price: '￥13', num: 1 } },
                ...
                { id: 11, name: '柯基', image: require("@/assets/img/dog.png"), category: 'pet', description: '可靠的护卫，忠诚而勇敢，像你的影子一样一直陪伴着你', extra: { price: '￥20', num: 1 } },
                { id: 12, name: '苹果', image: require("@/assets/img/apple.png"), category: 'food', description: '禁忌和知识的诱惑', extra: { price: '￥13', num: 1 } }
            ],
            categories: [
