...
- 攻击方法，点击对方，到达附近后（稍微与对方碰撞）产生交互事件，后端首先判断位置近不近（因为对方也会移动，也同时是为了防止作弊），随后决定是攻击，还是什么别的事件例如喂食狗狗？攻击会有颜色变化，并且显示血量减少（原血量-现血量）
- 添加启示之塔（或叫修道院）：一个修炼场所，精灵呆在里面一定时间可以获得特殊效果，例如“一定概率秒杀对方”或者“经验球”
- 设计以下武器：
  - 如果你的攻击力小于对方防御力，则你的攻击力为对方防御力加一
  - 埃阿斯之盾：减少7点伤害
  - 无视对方防具
  - 一定概率秒杀对方
  - 造成特定数值的固定伤害
