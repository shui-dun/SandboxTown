...
- 已知的bug：游戏窗口最小化后在放到前端，会出现各种奇怪问题，例如运动特别卡顿，可能是ws的问题？
- 已知的bug：远程部署时运动卡顿
...
- 各个精灵类型应有各自的basic生命上限和basic饱腹值上限，各个精灵应有hpLimit，hpLimitInc，hungerLimit 和 hungerLimitInc属性
- claude2的建议：
...
- 手机端主页背景（小球运动）卡顿
- 聊天的入口要在HomeView和GameView中都用，但GameView中的聊天窗口发送后马上关闭窗口，HomeView中则不会
...
- 在PC端，点击右键显示一个东西的信息，点击左键攻击他，在地图上右键一个位置移动到那里
